        ...
        <>
            {
                src ? (
                    <span
                        className={`${imageSize} relative inline-block overflow-hidden rounded-full ring-2 ring-white`}
                    >
                    ...
                    >
                         <svg className="h-full w-full text-gray-300" fill="currentColor" viewBox="0 0 24 24" role='img' aria-label={alt}>
                            <path
