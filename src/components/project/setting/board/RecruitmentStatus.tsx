    ...
    return (
        <div className="relative mobile:text-sm">
            ...
            <Switch
                ...
                className="group relative flex h-7 w-12 mt-2 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-primary transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-none  data-[headlessui-state=checked]:bg-gray-200"
            >
                <span className="sr-only">{statusName}</span>
                <span
                    className="pointer-events-none relative inline-block h-6 w-6 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out group-data-[headlessui-state=checked]:translate-x-5">
                    <span
                        aria-hidden="true"
