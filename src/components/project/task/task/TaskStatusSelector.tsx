...
import {MilestoneStatusItem, milestoneStatusItems} from "@/store/project/task/MilestoneStateStore";
...
function TaskStatusSelector() {
    const [currentForm, setCurrentForm] = useRecoilState(taskModalFormState);
