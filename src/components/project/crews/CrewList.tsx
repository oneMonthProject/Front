...
export default function CrewList() {
    ...
    return (
        <ul role="list" className="divide-y divide-gray-100">
            {data.projectMembers.map((value: ProjectMember) => {
                const {
                    lastWorkDate,
                    position: {name},
                ...
                return (
                    <li key={userId} className="flex items-center gap-x-6 py-5 cursor-pointer hover:bg-grey000">
                        <Link href={{
                            ...
                            query: {projectId, userId:userId.toString()}
                        }}
                            ...
                            <div className='tablet:ml-auto mobile:mr-auto flex items-center space-x-1 mobile:text-sm text-grey800'>
                                <span>마지막 작업 : </span>
