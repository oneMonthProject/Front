...
function ProjectInfo({projectId}: { projectId: string }) {
    ...
    return (
        <section
            ...
            <div className='flex-col pr-20 tablet:w-[460px] mobile:w-full'>
            ...
            <div
                className='h-full flex-col tablet:pl-20 mobile:p-1 mobile:mt-3 tablet:text-[1.25rem] mobile:text-[14px] font-semibold mobile:bg-ground200 mobile:rounded-md'>
