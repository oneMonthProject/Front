...
export default function HomePage() {
    ...
    return (
        <div className='relative'>
            <Button theme='primary' size='md' onClick={() => {}}>확인</Button>
            <Button theme='primary' size='sm' onClick={() => {}}>확인</Button>
            <Button theme='secondary' size='md' onClick={() => {}}>확인</Button>
            <Button theme='secondary' size='sm' onClick={() => {}}>확인</Button>
            <RoundButton theme='primary' size='md' onClick={() => {}}>Follow</RoundButton>
            <RoundButton theme='primary' size='sm' onClick={() => {}}>Follow</RoundButton>
            ...
            <Modal>
                <div className="p-4">
                    ...
                    <div
                        className="flex items-center justify-between pt-8 mx-auto text-gray-500 border-t border-gray-200 w-44">
                        <a href="#">
