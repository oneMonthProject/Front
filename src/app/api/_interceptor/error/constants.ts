...
export const ResponseNotOKMessage = {
    ...
    ACCESS_NOT_ALLOWED: {text: '접근 권한이 없습니다', status: HttpStatus.FORBIDDEN},
    NO_PERMISSION_TO_TASK: {text: '해당 작업에 대한 권한이 없습니다.', status: HttpStatus.FORBIDDEN},
    ...
    NO_OTHER_PROJECT_MANAGER: {
        text: '프로젝트에는 최소 1명의 매니저가 필요합니다. "프로젝트 설정"에서 다른 크루 최소 1명에게 매니저 권한을 부여하고 탈퇴를 시도해 주세요.',
